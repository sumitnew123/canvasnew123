...
mstPDPPopup(function($){
	...
	PDPPopup = {
		...
		createSample : function () {
			var	url = baseUrl + "pdp/view/designtool/product-id/" + productId + "/area/backend/key/46783db73cb9894e0ed77647840ef5b5";
			$(".create-sample-btn").on("click", function() {
				PDPPopup.openPopup(url, "Create Default Design", PDPPopup.setupAreaHandler );
			});
		}(),
        ...
        createNewTemplate: function() {
            $(".add-new-design-template").click(function() {
                window.location.href = $(this).attr("rel");
            });
        }(),
        viewTemplates : function () {
            var	url = $("#view_design_template_url").val() + "productid/" + productId;
            $(".view-design-btn").on("click", function() {
                PDPPopup.openPopup(url, "View Template Library", PDPPopup.setupAreaHandler );
            });
        }(),
        deleteTemplate: function() {
            $(".del-design-template").click(function() {
        ...
        selectDefaultTemplate: function() {
            $(".is-default-checkbox").click(function() {
                $(".is-default-checkbox").prop("checked", false);
		...
		reOrderAdditionalInfo : function() {
			...
			if($(".order-tables .item-container").length) {
