 ...
 */
/**
 * Bid admin grid block
 *
 * @category    Xcentia
 * @package     Xcentia_Projects
 * @author      Ultimate Module Creator
 */
class Xcentia_Projects_Block_Adminhtml_Bid_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Projects_Block_Adminhtml_Bid_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_projects/bid')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'amount',
            array(
                'header'    => Mage::helper('xcentia_projects')->__('Bid Amount'),
                'align'     => 'left',
                'index'     => 'amount',
            )
        );
        ...
        $this->addColumn(
            'date',
            array(
                'header' => Mage::helper('xcentia_projects')->__('Completion Date'),
                'index'  => 'date',
                'type'=> 'date',
        ...
        $this->addColumn(
            'selected',
            array(
                'header' => Mage::helper('xcentia_projects')->__('Is Selected'),
                'index'  => 'selected',
                'type'    => 'options',
                    'options'    => array(
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('bid');
        ...
        $this->getMassactionBlock()->addItem(
            'selected',
            array(
                'label'      => Mage::helper('xcentia_projects')->__('Change Is Selected'),
                'url'        => $this->getUrl('*/*/massSelected', array('_current'=>true)),
                'additional' => array(
                    'flag_selected' => array(
                        'name'   => 'flag_selected',
                        'type'   => 'select',
     ...
     *
     * @access public
     * @param Xcentia_Projects_Model_Bid
     * @return string
     * @author Ultimate Module Creator
     */
