 ...
 */
/**
 * vendor - categories relation edit block
 *
 * @category    Xcentia
 * @package     Xcentia_Vendors
 * @author      Ultimate Module Creator
 */
class Xcentia_Vendors_Block_Adminhtml_Vendor_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('xcentia_vendors/vendor/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited vendor
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the vendor is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getVendor()->getSelectedCategories();
            $ids = array();
    ...
    /**
     * Returns array with nodes those are selected (contain current vendor)
     *
     * @return array
     */
