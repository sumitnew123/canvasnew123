 ...
 */
class Xcentia_Vendors_Block_Adminhtml_Vendor_Comment_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->_updateButton(
            'save',
            'label',
            Mage::helper('xcentia_vendors')->__('Save Vendor comment')
        );
        $this->_updateButton(
            'delete',
            'label',
            Mage::helper('xcentia_vendors')->__('Delete Vendor comment')
        );
        $this->_addButton(
            'saveandcontinue',
            array(
