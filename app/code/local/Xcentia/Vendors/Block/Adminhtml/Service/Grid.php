 ...
 */
class Xcentia_Vendors_Block_Adminhtml_Service_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Vendors_Block_Adminhtml_Service_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_vendors/service')
            ->getCollection();
     ...
     *
     * @access public
     * @param Xcentia_Vendors_Model_Service
     * @return string
     * @author Ultimate Module Creator
     */
