 ...
 */
/**
 * Servicemap admin grid block
 *
 * @category    Xcentia
 * @package     Xcentia_Vendors
 * @author      Ultimate Module Creator
 */
class Xcentia_Vendors_Block_Adminhtml_Servicemap_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Vendors_Block_Adminhtml_Servicemap_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_vendors/servicemap')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'service_id',
            array(
                'header' => Mage::helper('xcentia_vendors')->__('Service'),
                'index'  => 'service_id',
                'type'=> 'number',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('servicemap');
     ...
     *
     * @access public
     * @param Xcentia_Vendors_Model_Servicemap
     * @return string
     * @author Ultimate Module Creator
     */
