 ...
 */
class Xcentia_Vendors_Block_Adminhtml_Contact_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Xcentia_Vendors_Block_Adminhtml_Contact_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('xcentia_vendors/contact')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'name',
            array(
                'header'    => Mage::helper('xcentia_vendors')->__('Name'),
                'align'     => 'left',
                'index'     => 'name',
            )
        );
        ...
        $this->addColumn(
            'email',
            array(
                'header' => Mage::helper('xcentia_vendors')->__('Email'),
                'index'  => 'email',
                'type'=> 'text',
        ...
        $this->addColumn(
            'mobile',
            array(
                'header' => Mage::helper('xcentia_vendors')->__('Mobile No'),
                'index'  => 'mobile',
                'type'=> 'text',
        ...
        $this->addColumn(
            'vendor_id',
            array(
                'header' => Mage::helper('xcentia_vendors')->__('Vendor Id'),
                'index'  => 'vendor_id',
                'type'=> 'number',
     ...
     *
     * @access public
     * @param Xcentia_Vendors_Model_Contact
     * @return string
     * @author Ultimate Module Creator
     */
