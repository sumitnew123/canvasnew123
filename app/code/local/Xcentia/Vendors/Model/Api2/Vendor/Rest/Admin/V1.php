 ...
 */
class Xcentia_Vendors_Model_Api2_Vendor_Rest_Admin_V1 extends Xcentia_Vendors_Model_Api2_Vendor_Rest
{
    ...
    protected function _create(array $data) {
        $vendor = Mage::getModel('xcentia_vendors/vendor')->setData($data);
        try {
            $vendor->save();
        }
        catch (Mage_Core_Exception $e) {
     ...
     *
     * @access protected
     * @param Xcentia_Vendors_Model_Vendor $entity
