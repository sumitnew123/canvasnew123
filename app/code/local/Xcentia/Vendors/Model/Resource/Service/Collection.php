 ...
 */
/**
 * Service collection resource model
 *
 * @category    Xcentia
 * @package     Xcentia_Vendors
 * @author      Ultimate Module Creator
 */
class Xcentia_Vendors_Model_Resource_Service_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Xcentia_Vendors_Model_Resource_Service_Collection
     * @author Ultimate Module Creator
     */
    public function addCategoryFilter($category)
    {
        ...
        if (!isset($this->_joinedFields['category'])) {
            $this->getSelect()->join(
                array('related_category' => $this->getTable('xcentia_vendors/service_category')),
                'related_category.service_id = main_table.entity_id',
                array('position')
            );
